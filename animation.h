...
public:
	...
	void setPlayFrame( int* playArr, int arrLen, BOOL bLoop, CALLBACK_FUNCTION cbFunction );
	void setPlayFrame( int* playArr, int arrLen, BOOL bLoop, CALLBACK_FUNCTION_PARAMETER cbFunction, void* obj );
