...
class monster1 : public gameNode
{

private:
	vector<tagmonster> _vBullet;
	vector<tagmonster>::iterator _viBullet;
	vector<tagmonster2> _vBullet2;
	vector<tagmonster2>::iterator _viBullet2;
	vector<tagmonster3> _vBullet3;
	vector<tagmonster3>::iterator _viBullet3;
	vector<tagmonster4> _vBullet4;
	vector<tagmonster4>::iterator _viBullet4;
	vector<tagmonster5> _vBullet5;
	vector<tagmonster5>::iterator _viBullet5;
	vector<tagmonster6> _vBullet6;
	vector<tagmonster6>::iterator _viBullet6;
	float movex;
	bool leftmove;
	bool rightmove;
	int bulletcount;
