...
void animation::setPlayFrame( int * playArr, int arrLen, BOOL bLoop, CALLBACK_FUNCTION cbFunction )
{
	_obj = NULL;
	_callbackFunction = cbFunction;
	_callbackFunctionParameter = NULL;
...
void animation::setPlayFrame( int * playArr, int arrLen, BOOL bLoop, CALLBACK_FUNCTION_PARAMETER cbFunction, void * obj )
{
	_obj = obj;
	_callbackFunction = NULL;
	_callbackFunctionParameter = cbFunction;
