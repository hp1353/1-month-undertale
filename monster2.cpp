...
HRESULT monster2::init()
{
	...
	bulletrc = RectMake(310, 360, 30, 30);
	...
	IMAGEMANAGER->addImage("m2battlebox", "image/undertale/battle/torielbattle/battlebox.bmp", 165, 140, true, RGB(255, 0, 255));
	...
	for (int i = 0; i < bulletMax; i++)
	{
		...
		bullet.bulletImage = IMAGEMANAGER->addFrameImage("bullet125", "image/undertale/battle/monster1/bullet1.bmp", 14, 22, 1, 1, true, (RGB(255, 0, 255)));
		bullet.speed = 0.1f;
		bullet.fire = false;
		bullet.count = 0;
		bullet.index = 1;
	...
	for (int i = 0; i < bulletMax; i++)
	{
		tag2monster2 bullet2;


		bullet2.bulletImage = IMAGEMANAGER->addFrameImage("bullet54", "image/undertale/battle/monster1/bullet.bmp", 14, 22, 1, 1, true, (RGB(255, 0, 255)));
		bullet2.speed = 0.1f;
		bullet2.fire = false;
		bullet2.count = 0;
		bullet2.index = 1;
	...
	for (int i = 0; i < bulletMax; i++)
	{
		tag2monster3 bullet3;


		bullet3.bulletImage = IMAGEMANAGER->addFrameImage("bullet25", "image/undertale/battle/monster1/bullet2.bmp", 13, 21, 1, 1, true, (RGB(255, 0, 255)));
		bullet3.speed = 1.1f;
		bullet3.fire = false;
		bullet3.count = 0;
		bullet3.index = 1;
	...
	for (int i = 0; i < bulletMax; i++)
	{
		tag2monster4 bullet4;


		bullet4.bulletImage = IMAGEMANAGER->addFrameImage("bullet35", "image/undertale/battle/monster1/bullet3.bmp", 12, 21, 1, 1, true, (RGB(255, 0, 255)));
		bullet4.speed = 1.1f;
		bullet4.fire = false;
		bullet4.count = 0;
		bullet4.index = 1;
	...
	for (int i = 0; i < bulletMax; i++)
	{
		tag2monster5 bullet5;


		bullet5.bulletImage = IMAGEMANAGER->addFrameImage("bullet45", "image/undertale/battle/monster1/bullet4.bmp", 13, 18, 1, 1, true, (RGB(255, 0, 255)));
		bullet5.speed = 0.1f;
		bullet5.fire = false;
		bullet5.count = 0;
		bullet5.index = 0;
	...
	for (int i = 0; i < bulletMax; i++)
	{
		tag2monster6 bullet6;


		bullet6.bulletImage = IMAGEMANAGER->addFrameImage("bullet55", "image/undertale/battle/monster1/bullet5.bmp", 13, 15, 1, 1, true, (RGB(255, 0, 255)));
		bullet6.speed = 1.1f;
		bullet6.fire = false;
		bullet6.count = 0;
		bullet6.index = 1;
	...
	IMAGEMANAGER->addImage("bullet1", "image/undertale/battle/monster2/bullet1.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet2", "image/undertale/battle/monster2/bullet2.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet3", "image/undertale/battle/monster2/bullet3.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet4", "image/undertale/battle/monster2/bullet4.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet5", "image/undertale/battle/monster2/bullet5.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet6", "image/undertale/battle/monster2/bullet6.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet7", "image/undertale/battle/monster2/bullet7.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet8", "image/undertale/battle/monster2/bullet8.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet9", "image/undertale/battle/monster2/bullet9.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet10", "image/undertale/battle/monster2/bullet10.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet11", "image/undertale/battle/monster2/bullet11.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet12", "image/undertale/battle/monster2/bullet12.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet13", "image/undertale/battle/monster2/bullet13.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet14", "image/undertale/battle/monster2/bullet14.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet15", "image/undertale/battle/monster2/bullet15.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet16", "image/undertale/battle/monster2/bullet16.bmp", 64, 68, false, false);
	IMAGEMANAGER->addImage("bullet17", "image/undertale/battle/monster2/bullet17.bmp", 64, 68, false, false);

	monster = IMAGEMANAGER->addFrameImage("monster2", "image/undertale/battle/monster2/monster2.bmp", 164, 108,2,1, false, false);
...
void monster2::render()
{
	...
	if (patten1attack)
	{
		...
		if (danceindex == 1)IMAGEMANAGER->findImage("bullet1")->render(getMemDC(), 290, 321);
		if (danceindex == 2)IMAGEMANAGER->findImage("bullet2")->render(getMemDC(), 290, 321);
		if (danceindex == 3)IMAGEMANAGER->findImage("bullet3")->render(getMemDC(), 290, 321);
		if (danceindex == 4)IMAGEMANAGER->findImage("bullet4")->render(getMemDC(), 290, 321);
		if (danceindex == 5)IMAGEMANAGER->findImage("bullet5")->render(getMemDC(), 290, 321);
		if (danceindex == 6)IMAGEMANAGER->findImage("bullet6")->render(getMemDC(), 290, 321);
		if (danceindex == 7)IMAGEMANAGER->findImage("bullet7")->render(getMemDC(), 290, 321);
		if (danceindex == 8)IMAGEMANAGER->findImage("bullet8")->render(getMemDC(), 290, 321);
		if (danceindex == 9)IMAGEMANAGER->findImage("bullet9")->render(getMemDC(), 290, 321);
		if (danceindex == 10)IMAGEMANAGER->findImage("bullet10")->render(getMemDC(), 290, 321);
		if (danceindex == 11)IMAGEMANAGER->findImage("bullet11")->render(getMemDC(), 290, 321);
		if (danceindex == 12)IMAGEMANAGER->findImage("bullet12")->render(getMemDC(), 290, 321);
		if (danceindex == 13)IMAGEMANAGER->findImage("bullet13")->render(getMemDC(), 290, 321);
		if (danceindex == 14)IMAGEMANAGER->findImage("bullet14")->render(getMemDC(), 290, 321);
		if (danceindex == 15)IMAGEMANAGER->findImage("bullet15")->render(getMemDC(), 290, 321);
		if (danceindex == 16)IMAGEMANAGER->findImage("bullet16")->render(getMemDC(), 290, 321);
		if (danceindex == 17)IMAGEMANAGER->findImage("bullet17")->render(getMemDC(), 290, 321);
	}
	if (!torhp0attack)
	{
		if (torcurhp > 0)
			IMAGEMANAGER->findImage("monster2")->frameRender(getMemDC(), 325 + torielboom, 135);
	...
	if (morefight && !moremorefight && textnum !=15)
	{
	...
	if (torturn)
	{
		IMAGEMANAGER->findImage("m2battlebox")->render(getMemDC(), 240, 250);
		if (goodman)
		{
	...
	if (_player->getPlayer()->viewEvery)
	{
		...
		char str11[128];
		sprintf_s(str11, "tortextnum :  %d ", tortextnum);
		...
		Rectangle(getMemDC(), bulletrc.left, bulletrc.top, bulletrc.right, bulletrc.bottom);
	}

}

void monster2::NumberSet()
{
	//레벨숫자 세팅
...
void monster2::BattleControl()
{
	...
	if (moremoreact)
	{
		...
		else if (moremoreactheartpoint == 280 && moremoreactheartpointy == 265 && textnum != 4 && textnum != 5 && textnum != 6 && textnum != 10) //먹기 식사하기
		{
			if (_player->getPlayer()->pressZ)
			{
				tindex = 0;
	...
	if (stopbar)
	{
		yourdmgbar = (attackbarmovex - 310) / 20;
		if (yourdmgbar < 0)
		{
...
void monster2::TextControlUpdate()
{
	tcount++;
	...
	if (textnum == 5)
	{
		if (tindex == 66)
		{
			...
			if (KEYMANAGER->isOnceDown('Z'))
			{
				...
				textnum = 0;
				oncetalk1 = true;
				mercycount = RND->getFromIntTo(1, 4);
				mercytext = true;
				gagegoneframe = true;
			}
		}
...
void monster2::TextControl()
{
	...
	HANDLE hInputFile;
	if (textnum == 1)
		hInputFile = CreateFile(_T("text/monster2/text1.txt"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, 0);
	if (textnum == 2)
		hInputFile = CreateFile(_T("text/monster2/text2.txt"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, 0);
	if (textnum == 3)
		hInputFile = CreateFile(_T("text/monster2/text3.txt"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, 0);
	if (textnum == 4)
		hInputFile = CreateFile(_T("text/monster2/text4.txt"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, 0);
	if (textnum == 5)
		hInputFile = CreateFile(_T("text/monster2/text5.txt"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, 0);
	
	if (textnum == 11)
		hInputFile = CreateFile(_T("text/monster2/text11.txt"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, 0);
	if (textnum == 12)
		hInputFile = CreateFile(_T("text/monster2/text12.txt"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, 0);
	if (textnum == 15)
		hInputFile = CreateFile(_T("text/monster2/text15.txt"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, 0);
...
void monster2::torielAttack()
{
	...
	if (mercytext)
	{
		...
		if (tortextnum % 4 == 1)tortextnum = 1;
		if (tortextnum % 4 == 2)tortextnum = 2;
		if (tortextnum % 4 == 3)tortextnum = 3;
		if (tortextnum % 4 == 0)tortextnum = 4;
	}

}

void monster2::torielUnderAttack()
{
...
void monster2::torielpatten1()
{

	dancecount++;
	if (dancecount % 10 == 0)danceindex++;
	if(danceindex > 17)
	{
		torturn = false;
		patten1attack = false;
...
void monster2::torielTextControl()
{
	...
	HANDLE hInputFile;
	if (tortextnum == 1)
		hInputFile = CreateFile(_T("text/monster2/hetalk/text1.txt"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, 0);
	if (tortextnum == 2)
		hInputFile = CreateFile(_T("text/monster2/hetalk/text2.txt"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, 0);
	if (tortextnum == 3)
		hInputFile = CreateFile(_T("text/monster2/hetalk/text3.txt"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, 0);
	if (tortextnum == 4)
		hInputFile = CreateFile(_T("text/monster2/hetalk/text4.txt"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, 0);
...
void monster2::torielTextControlUpdate()
{
	tortcount++;
	...
	if (tortextnum == 2)
	{
		...
		{
			talkend = true;
			if (KEYMANAGER->isOnceDown('Z') || danceindex > 5)
			{
...
void monster2::removebullet()
{
	...
	if (torturn)
	{
...

		{
			...
			if (IntersectRect(&RectMake(0, 0, 0, 0), &bulletrc, &heartbox) && !goodman)
			{
...
void monster2::fire(float x, float y)
{
	for (_viBullet = _vBullet.begin(); _viBullet != _vBullet.end(); ++_viBullet)
	{
		if (_viBullet->fire) continue;
...
void monster2::fire2(float x, float y)
{
	for (_viBullet2 = _vBullet2.begin(); _viBullet2 != _vBullet2.end(); ++_viBullet2)
	{
		if (_viBullet2->fire) continue;
...
void monster2::fire3(float x, float y, float angle, float speed)
{
	for (_viBullet3 = _vBullet3.begin(); _viBullet3 != _vBullet3.end(); ++_viBullet3)
	{
...
void monster2::fire4(float x, float y, float angle, float speed)
{
	for (_viBullet4 = _vBullet4.begin(); _viBullet4 != _vBullet4.end(); ++_viBullet4)
	{
...
void monster2::fire5(float x, float y, float angle, float speed)
{
	for (_viBullet5 = _vBullet5.begin(); _viBullet5 != _vBullet5.end(); ++_viBullet5)
	{
		if (_viBullet5->fire) continue;
...
void monster2::fire6(float x, float y, float angle, float speed)
{
	for (_viBullet6 = _vBullet6.begin(); _viBullet6 != _vBullet6.end(); ++_viBullet6)
	{
		if (_viBullet6->fire) continue;
